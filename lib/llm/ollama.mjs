...
- "behaviors" lists what runs. Each has {trigger, body:[]} where trigger is one of: start, http_get, http_post, http_put, http_patch, http_delete, route, loop, if.
- Allowed stmt kinds: print, ask, set, call, if, for, return, http_get, http_post, http_put, http_patch, http_delete, http_serve, http_route, route, json_load, json_save, file_read, file_write, file_rename, file_delete, log, sleep, assert, raw.

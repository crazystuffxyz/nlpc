...
const STMT_PROPS = {
  kind: { enum: ['print', 'ask', 'set', 'call', 'if', 'for', 'return', 'http_get', 'http_post', 'http_put', 'http_delete', 'http_serve', 'http_route', 'route', 'json_load', 'json_save', 'file_read', 'file_write', 'file_rename', 'file_delete', 'log', 'sleep', 'assert', 'raw'] },
  text: { type: 'string' },
  name: { type: 'string' },
  value: {},
  args: { type: 'array' },
